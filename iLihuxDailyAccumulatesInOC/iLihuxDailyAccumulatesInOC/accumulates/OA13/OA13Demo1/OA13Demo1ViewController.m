...
@interface OA13Demo1ViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
@implementation OA13Demo1ViewController
...
{
    OA13Demo1CollectionViewCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:@"OA13Demo1CollectionViewCell" forIndexPath:indexPath];
