...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text boundingRectWithSize:CGSizeMake(maxWidth, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:label.font, NSParagraphStyleAttributeName:style} context:nil].size;
	// CGSize labelSize = [label.text sizeWithFont:label.font constrainedToSize:CGSizeMake(maxWidth, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping];
    ...
    NSMutableParagraphStyle *details_style = [[NSMutableParagraphStyle alloc] init];
    style.lineBreakMode = detailsLabel.lineBreakMode;
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:detailsLabel.font, NSParagraphStyleAttributeName:details_style} context:nil].size;
